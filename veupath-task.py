# -*- coding: utf-8 -*-
"""
Created on Mon Jan 23 14:34:15 2023

@author: telma
"""
## first I compared the organisms on toxobd
# I transformed orthologs for each comparison and looked for gene pathways
# VEG seems to cause the number of KEGG pathways found to decrease from ~2000 
# to 150. Without further analysis, I'd guess it's either because its is 
# phylogenetically distant from ME49 and GT1 and shares fewer pathways, 
# or that is it less complete.
...
## Then I had quick a look on OrthoMCL to compare
...
# Finding the othogroups that are shared between the three genomes by counting  
# the occurance of each ortholog by toxoplasma strain.
# Sadly this takes quite a while to run and I know could probably be improved 
# and I can actually do this faster with OrthoMCL, but here we are
...
# I would normally use complexupset in R for something like this to make an upsetplot
...
# Ideally, if I had time,  I'd also like to do an enrichment analysis between each 
# genome to see what functions are common/different between each set
# I'd take the GO enrichment analysis from the toxodb, but with 
# visulaisation like g:GOSt displaying fold enrichment and p-values 
